  ...
  wsdl: {
    ...
    "1.6": {
      ...
      BootNotificationRequest: {
        ...
        chargePointSerialNumber: 'jhfghyh000e48',
        chargeBoxSerialNumber: 'hygtr000e48',
...
/*
      ...
      UpdateFirmwareRequest: {
        retrieveDate: formatDate(new Date()),
      ...
      GetCompositeScheduleResponse: {
        status: 'Accepted',
		connectorId: 0,
		scheduleStart: formatDate(new Date()),
		chargingSchedule: {
				"duration": 86400,
				"chargingRateUnit": "W",
				"chargingSchedulePeriod": [{
